...
func init() {
	rootCmd.PersistentFlags().StringVarP(&user, "user", "u", "useradmin", "factory mode auth username")
	rootCmd.PersistentFlags().StringVarP(&passwd, "pass", "p", "d74pz", "factory mode auth password")
